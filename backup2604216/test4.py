...
mean_c1, cd1 = scipy.stats.mode( c1, axis = 0 )
mean_c2, cd2 = scipy.stats.mode( c2, axis = 0 )
mean_c3, cd3 = scipy.stats.mode( c3, axis = 0 )
...
dummy1, nearest_c1 = searchTree_c1.query( mean_c1[0], k = 4 )
dummy2, nearest_c2 = searchTree_c2.query( mean_c2[0], k = 4 )
dummy3, nearest_c3 = searchTree_c3.query( mean_c3[0], k = 4 )

# n vectores donde n = tamanio del vecto
