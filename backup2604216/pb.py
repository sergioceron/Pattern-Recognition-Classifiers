...
for _bar in (DownloadProgressSpinner, DownloadProgressSpinnerMoon, DownloadProgressSpinnerPie, DownloadProgressSpinnerLine, DownloadProgressBarShady, DownloadProgressBarCharging, DownloadProgressBarFillingSquares, DownloadProgressBarFillingCircles):
	bar = _bar( max = LENGTH  )
	bar.suffix = ''
