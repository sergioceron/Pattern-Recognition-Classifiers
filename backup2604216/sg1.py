# EN ESTA VERSION SE PROBARON 3 METODOS PARA CALCULAR LOS COEFICIENTES: MIN, MEAN, MODE
# LOGRANDO UN PERFORMANCE MIN>MEAN>MODE (APROX 85% IRIS), YA QUE SE REDUJO LA HEURISTICA
