...
# CALCULAR EL VERDADERO PERFORMANCE, CORREGIDO Y SIN EXCEPCIONES RESPECTO A LA VERSION ANTERIOR
...
def J(p, *args):
    ...
    # EN LAS MEDIAS DE LOS COEFICIENTES SE PIERDE MUCHA INFORMACION, SE CORREGIRA EN LA SIGUIENTE VERSION
    cc_means = []
    for i in range( c ):
...
for train_index, test_index in loo:
    ...
    for i in range( N - 1 ):
        test = test_ds[0, 0:m]
        # !!!!!! ESTA ES UNA PENDEJADA, AQUI TEST TIENE QUE SER TRAIN_DS[I, 0:M]
