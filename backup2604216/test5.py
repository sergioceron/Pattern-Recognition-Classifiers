...
dummy1, nearest_c1 = searchTree_c1.query( mean_c1[0], k = 4, p = 4 )
dummy2, nearest_c2 = searchTree_c2.query( mean_c2[0], k = 4, p = 4 )
dummy3, nearest_c3 = searchTree_c3.query( mean_c3[0], k = 4, p = 4 )
