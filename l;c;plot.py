# LA PRIMER PRUEBA GRAFICANDO EL CAMBIO DE BASE. EN ESTE CASO, PARA FORMAR EL SISTEMA GENERADOR
# SE TOMAN LOS N*MULT - MAS CERCANOS, EN VEZ DE SOLO LOS N - MAS CERCANOS
# EL RESULTADO: NO MEJORA EL RENDIMIENTO Y TAMPOCO HAY UN CRITERIO PARA SELECCIONAR EL MULTIPLICADOR
# ADEMAS DE QUE, PARA VALORES RELATIVAMENTE BAJOS (I.E. MULT=10) SE ABACABAN LOS PATRONES
import numpy as np
